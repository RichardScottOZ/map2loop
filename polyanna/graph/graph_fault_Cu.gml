...
graph [
  ...
  node [
    id 26
    LabelGraphics [ text "A-FOk-b[1]" fontSize 14 ]
    gid -1
  ...
  node [
    id 50
    LabelGraphics [ text "A-GR-mg[1]" fontSize 14 ]
    gid -9
    graphics [ fill "#f3fff3" w 150 ]
  ]
  node [
  ...
  node [
    id 10
    LabelGraphics [ text "CP-_pa-sepg[1]" fontSize 14 ]
    gid -14
    graphics [ fill "#f3fff3" w 150 ]
  ]
  node [
  ...
  node [
    id 0
    LabelGraphics [ text "K-_fz-st[9]" fontSize 14 ]
    gid -14
    graphics [ fill "#8dff8d" w 150 ]
  ]
  node [
    id 18
  ...
  node [
    id 1
    LabelGraphics [ text "P_-LAm-stq[8]" fontSize 14 ]
    gid -26
    graphics [ fill "#99ff99" w 150 ]
  ]
  node [
    id 13
    LabelGraphics [ text "P_-LAp-kd[2]" fontSize 14 ]
    gid -26
  ...
  node [
    id 29
    LabelGraphics [ text "P_-TAk-sp[3]" fontSize 14 ]
    gid -22
    graphics [ fill "#d9ffd9" w 150 ]
  ]
  node [
  ...
  node [
    id 11
    LabelGraphics [ text "P_-THb-shh[20]" fontSize 14 ]
    gid -44
    graphics [ fill "#00ff00" w 150 ]
  ]
  node [
    id 9
    LabelGraphics [ text "P_-THc-stq[1]" fontSize 14 ]
    gid -44
    graphics [ fill "#f3fff3" w 150 ]
  ]
  node [
  ...
  node [
    id 30
    LabelGraphics [ text "P_-_is-kx[9]" fontSize 14 ]
    gid -44
    graphics [ fill "#8dff8d" w 150 ]
  ]
  node [
    id 14
    LabelGraphics [ text "P_-_ya-mls[1]" fontSize 14 ]
    gid -51
    graphics [ fill "#f3fff3" w 150 ]
  ]
  node [
    id 7
    LabelGraphics [ text "P_-md-PTRB[1]" fontSize 14 ]
    gid -51
    graphics [ fill "#f3fff3" w 150 ]
  ]
  node [
  ...
  node [
    id 20
    LabelGraphics [ text "P_-xg-mn-PTRT[5]" fontSize 14 ]
    gid -54
    graphics [ fill "#c0ffc0" w 150 ]
  ]
  node [
    id 24
    LabelGraphics [ text "P_-xmb-md-PTRC[9]" fontSize 14 ]
    gid -51
    graphics [ fill "#8dff8d" w 150 ]
  ]
  edge [
    ...
    LabelGraphics [ text "3" fill "#d9ffd9" fontSize 14 fontStyle "bold" model "centered" position "center" outline "#000000"]
  ]
  edge [
    source 2
    target 17
  ...
  edge [
    ...
    LabelGraphics [ text "8" fill "#99ff99" fontSize 14 fontStyle "bold" model "centered" position "center" outline "#000000"]
  ]
  edge [
    source 25
    target 23
  ...
  edge [
    ...
    LabelGraphics [ text "4" fill "#ccffcc" fontSize 14 fontStyle "bold" model "centered" position "center" outline "#000000"]
  ]
  edge [
    source 16
    target 9
